...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        uCaseLastName = uCase.compose(lastName);    // compose means apply the uCase value last name
        System.out.println(uCaseLastName.apply(name));
...
//                .andThen(s -> s[1].toUpperCase() + ", " + s[0])
                .andThen(s -> STR."\{s[1].toUpperCase()}, \{s[0]}");
        ...
        System.out.println(STR."combined1 = \{combined1.test(name)}");

        Predicate<String> combined2 = p3.and(p4);
        System.out.println(STR."combined2 = \{combined2.test(name)}");

        Predicate<String> combined3 = p3.and(p4).negate();
        System.out.println(STR."combined3 = \{combined3.test(name)}");
