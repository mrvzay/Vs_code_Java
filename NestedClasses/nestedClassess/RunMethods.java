...
import nestedClassess.domain.Employee;
import nestedClassess.domain.EmployeeComparator;
import nestedClassess.domain.StoreEmployee;
...
public class RunMethods {
  ...
  public static void main(String[] args) {
    ...
    // Up and down lines excatly same but below line using lambda expression
